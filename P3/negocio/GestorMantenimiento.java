...
public class GestorMantenimiento {
    ...
    public boolean iniciarSesionTecnico(String cedula, String password) { // ◄ AHORA RECIBE LA CLAVE
        for (Tecnico t : catalogoTecnicos) {
            if (t.getCedula().equals(cedula) && t.getPassword().equals(password)) { // ◄0 VALIDA AMBAS
