...
import P3.negocio.GestorMantenimiento;
import P3.modelo.activos.*;
import P3.modelo.actores.Tecnico;
import P3.modelo.operaciones.Analisis;
import P3.modelo.operaciones.Mantenimiento;
import P3.modelo.excepciones.*;
...
public class MainInterfaz extends JFrame {
    ...
    public MainInterfaz() {
        ...
        try {
            ...
            gestor.registrarTecnico(new Tecnico("1723456789", "Ing. Martin Perez", "Automatización", "clave123"));
    ...
    private void inicializarComponentesLogin() {
        ...
        btnLogin.addActionListener(e -> {
            ...
            if ("Administrador".equals(rol)) {
                ...
                if ("Majo".equalsIgnoreCase(user) && "majo123".equals(pass)) {
    ...
    private void configurarMenuPrincipal(boolean isAdmin) {
        ...
        if (isAdmin) {
            ...
            tabsMenuPrincipal.addTab("Estado de Motores", panelEstadoComun); // ◄ VISIBLE PARA ADMIN
            ...
            tabsMenuPrincipal.addTab("Estado de Motores", panelEstadoComun); // ◄ VISIBLE PARA TÉCNICOS
        }
