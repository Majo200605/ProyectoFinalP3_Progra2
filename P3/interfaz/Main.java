...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            gestor.registrarTecnico(new Tecnico("1723456789", "Martin Perez", "Automatizacion", "clave123"));
            gestor.registrarMotor(new MotorTrifasico("101", 15.0, 30.0, 220.0, "A1", "Delta"));
